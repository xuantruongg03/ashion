<?php include "../functions/get_products.php"; ?>
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="sidebar__categories">
                            ...
                            <div class="categories__accordion">
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseThree">Thời trang trẻ em</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseFour">Trang sức</a>
                                        </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row">
                        <?php
                            $sql_product = "SELECT product_id, product_name, product_price, product_rate, product_type FROM products order by product_created_at";
                            ...
                            foreach ($productList as $product) {
                                ...
                                include "../components/product_item/product_item2.php";
                            }
                        ?>
